...
class UpdateSharedWithTable extends Migration {
	...
	public function up()
	{
		Schema::table('shared', function(Blueprint $table)
		{
			...
			$table->index(array('sharedwith_id', 'sharedwith_type'));
			
			$table->unique(array('token', 'sharedwith_id', 'sharedwith_type'));
		});
	}
	...
	public function down()
	{
		Schema::table('shared', function(Blueprint $table)
		{
			...
			$table->index(array('with_id', 'with_type'));
			
			$table->unique(array('token', 'with_id', 'with_type'));
		});
	}
