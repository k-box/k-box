...
class TermsLoadCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'terms:load';
     ...
     * @var string
     */
    protected $description = 'Create the terms of service page from the templates';
    ...
    public function handle()
    {
        ...
        if ($created->isEmpty()) {
            $this->line('Terms already existing, nothing to do');
        } else {
            $this->line('Terms page loaded');
        }
