...
class DmsUserImportCommand extends Command {
	...
	protected $data_row_validation_rules = [
        ...
        'manage_projects' => 'sometimes|array|exists:projects,name',
        'add_to_projects' => 'sometimes|array|exists:projects,name',
    ];
    ...
    private function createUser($parameters){
        ...
        if( !empty($parameters['manage_projects']) ){
            ...
            // $this->line('Managed projects transaction return ' . var_export($transaction_return, true));
