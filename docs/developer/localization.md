...
Language files an localization rules follows the [Laravel Localization](https://laravel.com/docs/7.x/localization). 
...
- [`trans`](https://laravel.com/docs/7.x/helpers#method-trans)
- [`trans_choice`](https://laravel.com/docs/7.x/helpers#method-trans-choice)
