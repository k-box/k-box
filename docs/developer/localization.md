...
Language files an localization rules follows the [Laravel Localization](https://laravel.com/docs/localization). 
...
- [`trans`](https://laravel.com/docs/helpers#method-trans)
- [`trans_choice`](https://laravel.com/docs/helpers#method-trans-choice)
