...
@endif
<select class="form-select block w-2/3" required name="type" id="type" @if(isset($provider)) disabled @endif>
...
@endif
<input class="form-input block w-2/3" type="text" required name="label" id="label" value="{{old('label', $provider['label'] ?? '')}}">
</div>
...
@endif
<input class="form-input block w-2/3" type="text" required name="url" id="url" value="{{old('url', $provider['url'] ?? '')}}">
</div>
...
@endif
<input class="form-input block w-2/3" type="text" required name="attribution" id="attribution" value="{{old('attribution', $provider['attribution'] ?? '')}}">
</div>
...
@endif
<input class="form-input block w-2/3" type="text" name="maxZoom" id="maxZoom" value="{{old('maxZoom', $provider['maxZoom'] ?? '20')}}">
</div>
...
@endif
<input class="form-input block w-2/3" type="text" name="layers" id="layers" value="{{old('layers', $provider['layers'] ?? '')}}">
</div>
...
@endif
<input class="form-input block w-2/3" type="text" name="subdomains" id="subdomains" value="{{old('subdomains', $provider['subdomains'] ?? '')}}">
</div>