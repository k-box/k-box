...
return [
    ...
    */
    ...
    'hints' => [
        ...
        'delete_microsite' => 'Supprimer le microsite du projet',
        'edit_microsite' => 'Modifier le contenu et les paramètres du microsite',
        
        'site_title' => 'Le nom du site web qui sera montré aux utilisateurs',
        'slug' => 'La version conviviale de l\'URL du site web. Cela aidera les utilisateurs à trouver et à se souvenir de l\'adresse. Ne peut pas commencer avec le mot "create".',
        ...
        'default_language' => 'La langue dans laquelle le site web sera affiché, si l\'utilisateur ne choisit pas explicitement une autre langue',
        ...
        'page_title' => 'Le titre de la page. Le titre par défaut est "home"',
        'page_slug' => 'La version conviviale de l\'URL du site web. Cela aidera les utilisateurs à trouver et à se souvenir de l\'adresse',
        'page_content' => 'Vous pouvez ajouter du texte, des liens et du texte formatté. Le formattage se base sur <a href="https://daringfireball.net/projects/markdown/basics" target="_blank">la syntaxe Markdown</a>. Vous pouvez aussi insérer des liens ou des éléments intégrés d\'autres sites web. Par exemple vous pouvez intégrer un flux RSS en mettant ce code sur une ligne: <code>@rss:https://klinktest.wordpress.com/feed/</code>. Veuillez noter que le contenu intégré sera mis en cache pour prévenir une utilisation excessive des ressources du serveur. La durée de vie du cache se situe entre 1 et 4 heures, selon le service',
    ],
    ...
    'errors' => [
        ...
        'create_no_project' => 'Veuillez spécifier un projet. Aucun projet n\'a été spécifié pour permettre la création du microsite.',
