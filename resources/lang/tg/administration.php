    ...
    */
    ...
    'accounts' => [
        ...
        'labels' => [
            ...
            'empty_means_generated_password' => 'Агар холӣ монад, гузарвожа тасодуфӣ cохта мешавад',
        ],

        'capabilities' => [

            'manage_dms' => 'Истифодабаранда метавонад ба панели K-Box дастрасӣ пайдо кунад',
            'publish_to_klink' => 'Истифодабаранда метавонад аёнияти cанадҳоро тағйир диҳад',
            ...
            'create_projects' => 'Истифодабаранда метавонад Лоиҳа созад',            
    ...
    'mail' => [
        ...
        'from_address' => 'Суроғаи E-Mail (мисол. firuz@organization.com)',
        'from_name_placeholder' => 'Фируз',
        'from_address_placeholder' => ' мисол firuz@organization.com',
    ...
    'analytics' => [
        'save_btn' => 'Сабти Танзимоти Таҳлил',
        'saved' => 'Танзимоти Таҳлил аз нав карда шуд.',
        'save_error' => 'Танзимоти Таҳлил аз нав карда намешаванд. :error',
        'section' => 'Таҳлил',
        'section_help' => 'Дар ин бахш шумо метавонед K-Box-ро барои хадамотхои Таҳлилӣ танзим кунед. ',
        'token_field' => 'Токени Таҳлил',
        'service_field' => 'Хадамоти Таҳлилӣ',
        'domain_field' => 'URL-и хадамоти Таҳлилӣ',
    ],
    
    'support' => [
        'section' => 'Дастгирӣ',
        'section_help' => 'Агар шумо обунаи дастгирии UserVoice дошта бошед, лутфан нишони аутентификатсияро дохил кунед, то истифодабарандаатон дархостҳои дастгирии худро пешниҳод кунанд.',
        'token_field' => 'Токени Дастгирӣ',
        'save_btn' => 'Сабти Танзимоти Дастгирӣ',
        'saved' => 'Танзимоти Дастгирӣ аз нав карда шуд.',
        'save_error' => 'Танзимоти Дастгирӣ аз нав карда намешавад. :error',
    ],
