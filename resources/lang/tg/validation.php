...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'folder_import' => [
            'required_if' => 'Шумо бояд папкаи дурустро барои оғоз кардани воридот муайян кунед.',
        ],
        'remote_import' => [
            'required_if' => 'Шумо бояд url-и дурусти сахфаро муайян кунед барои оғози воридот.',
        ],
        'users' => [
            'required' => 'Лутфан ҳадди аққал як истифодабарандаро интихоб кунед.',
        ],
        'document' => [
            'required' => 'Санаде, ки шумо бор мекунед, аз андозаи ҳадди аксари иҷозат дода шуда зиед аст '.\Config::get('dms.max_upload_size').' KB',
