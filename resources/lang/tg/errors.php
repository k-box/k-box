...
return [
    ...
    */
    ...
    'import' => [
        'folder_not_readable' => 'Папкаи :folder хонда намешавад. Бубинед оё ичозати хонадани он доред ё на.',
        'url_already_exists' => 'Файл аз вебсайти url (:url) аллакай ворид карда шудааст.',
        'download_error' => 'Санади ":url" фаро кашидан намешавад. :error',
    ],
