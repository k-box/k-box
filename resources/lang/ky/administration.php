...
return [
    ...
    */
    ...
    'menu' => [
        ...
        'maintenance'=>'Тейлөө жана журнал жазуулар',
        'institutions'=>'Уюмдар',
        'settings'=>'Орнотуу',
    ...
    'accounts' => [
        ...
        'capabilities' => [
            ...
            'manage_dms' => 'K-Box башкаруу панелине мүмкүндүк алуу',
            'manage_dms_users' => 'K-Box колдонуучунун каттам жазуусун башкаруу',
            'manage_dms_log' => 'K-Box журналын карап чыгуу',
            ...
            'import_documents' => 'Папкеден же тышкы URLдан документтерди импорттоо',
            ...
            'manage_share_personal' => 'Башка колдонучууларга жабык документтерди көрүү мүмкүнчүлүгүн берүү',
            'manage_share_private' => 'Өзүнчө уюмдун дэнгээлинде белгиленген колдонуучулардын группасына башка колдонучууларга жабык документтерин көрүү мүмкүнчүлүгүн берүү',
            'clean_trash' => 'Жүктөлгөн документтерди кайтарылбас өчүрүү мүмкүнчүлүгү',
            'manage_personal_people' => 'Жеке дэнгээлде белгиленген колдонуучу группаларын түзүү жана өзгөртүү',
            'manage_people' => 'Уюм дэнгээлинде белгиленген колдонуучулардын группаларын түзүү жана өзгөртүү',
        ...
        'reset_sent' => 'Сырсөздү жаңылантуу боюнача кат :name (:email) почтага жөнөтүлдү',
        'reset_not_sent' => 'Сырсөздү жаңылантуу боюнача катты бул почтага :email. :error жөнөтүү мүмкүн эмес',
        'reset_not_sent_invalid_user' => 'Колдонуучуну :email табуу мүмкүн эмес',
        'send_reset_password_btn' => 'Сырсөздү жаңылантуу',
        'send_reset_password_hint' => 'Сырсөздү өзгөртүү үчүн шилтемени сурам кылуу',
        'send_message_btn' => 'Билдирүү жөнөтүү',
        'send_message_btn_hint' => 'Ар бир колдонуучуга билдирүү жөнөтүү',
    ],
    ...
    'storage' => [
        ...
        'naming_policy_title' => 'Документтердин аталышынын эрежеси',
        'naming_policy_description' => 'Система документтердин аталышынын эрежесине дал келбеген документтерди жүктөөгө тыйуу салышы мүмкүн',

        'naming_policy_btn_activate' => 'Иштетүү',
    ...
    'network' => [
        ...
        'ksearch' => 'K-Search издөө машинасы менен байланышуу',
        'ksearch_description' => 'Бул жерде K-Box менен издөө машинаны байланыш абалы көрсөтүлгөн',
    ...
    'mail' => [
        ...
        'server_configuration_description' => 'Бул жерде K-Boxту менен почта серверин бириктирүү боюнча орнотуулар көрсөтүлгөн',
        'from_name' => 'Аты',
        ...
        'encryption_label' => 'Почта адресин шифрлөө протоколу',
    ...
    'maintenance' => [
        ...
        'logs_widget_title' => 'Логдун акыркы жазылуусу',
    ],
    ...
    'settings' => [
        ...
        'support_section_help' => 'K-Link колдоо кызматтарына жазылган болсоңуз, аутентификациялоо маркерин көрсөтүңүз, колдонуучулар суроо-талап жана жардам алууга мүмкүнчүлүгү пайда болот.',
        'support_token_field' => 'Маркер',
        'support_save_btn' => 'Сактоо',
        
        'analytics_section' => 'Аналитика',
        'analytics_section_help' => 'K-Link аналитикасына мүмкүндүк алуу үчүн аутентификациялоо маркерин көрсөтүңүз',
    ...
    'documentlicenses' => [
        ...
        'default' => [
            ...
            'description' => 'Лицензия башка адамдар сиздин чыгармаңызды пайдалануусун белгилейт. Лицензия жаңы жүктөлгөн файлдарга колдонулат.',
            'label' => '',
            ...
            'saved' => 'Стандарттык лицензия сакталды. Жаңы файлдарга карата автоматтык түрдө ":title" лицензиясы колдонулат. Аны ар бир колдонуучу оз каалоосу боюнча өзгөртө алат.',
        ...
        'available' => [
            'title' => 'Лицензиялар',
            'description' => 'Лицензия түрлөрү боюнча орнотуулар',
            'label' => '',
            'save' => 'Сактоо',
