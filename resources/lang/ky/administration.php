    ...
    */
    ...
    'accounts' => [
        ...
        'capabilities' => [
            ...
            'manage_personal_people' => 'Жеке дэңгээлде түзүлгөн колдонуучу группаларын түзүү жана өзгөртүү',
    ...
    'documentlicenses' => [
        ...
        'default' => [
            ...
            'saved' => 'Стандарттык лицензия сакталды. Жаңы файлдарга карата автоматтык түрдө ":title" лицензиясы колдонулат. Аны ар бир колдонуучу оз каалоосу менен өзгөртө алат.',
