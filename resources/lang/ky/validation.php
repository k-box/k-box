...
return [
    ...
    */
    ...
    "required_if"          => ":other :value болгондо, :attribute талаасыны толтуруу милдеттүү",
    "required_with"        => ":values болгондо, :attribute талаасыны толтуруу милдеттүү",
    "required_with_all"    => ":values болгондо, :attribute талаасыны толтуруу милдеттүү",
