...
*/
    ...
    'messages' => [
        ...
        'delete_public_forbidden' => 'Ачык документти өчүрүүгө мүмкүнчүлүгүңүз жок, администраторго кайрылыңыз',
        'delete_force_forbidden' => 'Документти толугу менен өчүрүүгө мүмкүнчүлүгүңүз жок, администраторго кайрылыңыз',
        'drag_hint' => 'Файлды жуктөө үчүн аны ушул жерге мышка менен алып келиңиз',
        'recent_hint_dms_manager' => 'Жеткиликтүү долбоорлордогу акыркы өзгөртүгөн файлдар',
