...
return [
    ...
    */
    ...
    'settings' => [
        ...
        'enabled' => 'Документтерди жарыялоого уруксат берүү',
        ...
        'streaming_section_help' => 'Видеону жарыялоо үчүн видео көрсөтүүнү жандырыңыз',
        'streaming_service_url' => 'Видео көрсөтүүнүн адреси',
    ],
