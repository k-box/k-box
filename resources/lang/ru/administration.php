...
return [
    ...
    */
    ...
    'documentlicenses' => [
        ...
        'view_license' => 'Посмотреть лицензию',
        ...
        'default' => [
            'title' => 'Стандартная лицензия по умолчанию',
            'description' => 'Лицензия определяет использование вашей работы другими людьми. Лицензия по умолчанию применяется по отношению к новым загрузкам.',
            'label' => '',
            'save' => 'Сохранить стандартную лицензию',
            'no_licenses_error' => 'Лицензии не настроены на данном K-Box. Пожалуйста, настройте их перед выбором стандартной лицензии.',
            'saved' => 'Стандартные настройки по защите авторского права сохранены. Новым загрузкам будет автоматически присваиваться лицензия ":title" которую можно изменить индивидуально по желанию.',
            ...
            'apply_default_license_all' => 'Применить ко всем документам стандартную лицензию',

        ],
        'available' => [
            'title' => 'Доступные лицензии на данном K-Box',
            'description' => 'Вы можете настроить лицензии которые будут применяться к данным, которые были загружены на этот K-Box',
            'label' => '',
            'save' => 'Сохранить',
