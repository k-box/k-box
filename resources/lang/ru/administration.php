	...
	*/
	...
	'accounts' => array(
		...
		'capabilities' => array(
			...
			'clean_trash' => 'Пользователь иммет право на безвозвратное удаление документов',
			
			'manage_personal_people' => 'Пользователь может создать/изменять группы пользователей определенных на личном уровне',
			'manage_people' => 'Пользователь может создать/изменять группы пользователей определенных на уровне организации',
	...
	'settings' => array(
        ...
        'klinkpublic_section' => 'K-Link Внешний',
		'klinkpublic_section_help' => 'Настроить доступ ко Внешней сети K-Link',
		'klinkpublic_enabled' => 'Разрешить публикацию документов в K-Link Внешний',
		'klinkpublic_debug_enabled' => 'Разрешить отладку соединения K-Link',
		'klinkpublic_username' => 'Пользователь, используемый для опознования в K-Link Внешний',
		'klinkpublic_password' => 'Пароль, используемый для опознования в K-Link Внешний',
		'klinkpublic_url' => 'URL, используемый для исходного узла K-Link Внешний',
