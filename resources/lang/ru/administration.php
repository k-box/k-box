    ...
    */
    ...
    'accounts' => [
        ...
        'capabilities' => [
            ...
            'manage_dms' => 'Доступ к управляющей панели K-Box',
            'manage_dms_users' => 'Управление учетными записями пользователей K-Box',
            'manage_dms_log' => 'Просмотр журнала K-Box',
            ...
            'delete_document' => 'Возможность перемещения документов в корзину',
            'import_documents' => 'Импортирование документов из папок или внешнего URL',
            'upload_documents' => 'Возможность загрузки документов',
            ...
            'manage_project_collections' => 'Возможность внесения изменений в структуре доступных проектов',
            'manage_share' => 'Предоставление доступа к неопубликованным документам другим пользователям',
            ...
            'manage_share_private' => 'Предоставление доступа к неопубликованным документам группе пользователей, определенных на организационном уровне',
            'clean_trash' => 'Возможность безвозвратного удаления загруженных документов',
            'manage_personal_people' => 'Создание и изменение групп пользователей, определенных на личном уровне',
            'manage_people' => 'Создание и изменение групп пользователей, определенных на уровне организации',
