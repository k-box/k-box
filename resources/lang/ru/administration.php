    ...
    */
    ...
    'accounts' => [
        ...
        'labels' => [
            ...
            'generate_password' => 'Сгенерировать пароль пользователя',
            'send_password' => 'Отправить пароль пользователю по электронной почте',
            'no_password_sending' => 'Введите пароль для выбранного пользователя. 
            Сервер электронной почты не настроен, K-Box не может генерировать и отправлять пароли напрямую по электронной почте.',
            'empty_means_generated_password' => 'Пароль будет сгенерирован, если оставить поле пустым',
        ],
        ...
        'created_msg' => 'Пользователь создан', // old string - 'Пользователь создан. Пароль был отправлен лично пользователю на почту',
        'created_password_sent_msg' => 'Пользователь был успешно создан. Пароль был отправлен прямо на электронную почту пользователя.',
        'created_no_mail_msg' => 'Пользователь создан. Не удалось отправить пароль на электронную почту пользователя',
    ...
    'analytics' => [
        'save_btn' => 'Сохранить настройки Аналитики',
        'saved' => 'Настройки Аналитики обновлены.',
        'save_error' => 'Невозможно обновить настройки аналитики. :error',
        'section' => 'Аналитики',
        'section_help' => 'В этом разделе вы можете настроить K-Box для использования аналитического сервиса. Службу аналитики можно использовать для отслеживания посещений страниц и поисков.',
        'token_field' => 'Токен аналитики',
        'service_field' => 'Сервис аналитики',
        'domain_field' => 'URL службы аналитики',
    ],

    'support' => [
        'section' => 'Служба поддержки',
        'section_help' => 'Если у вас есть подписка на поддержку UserVoice, пожалуйста, вставьте сюда токен аутентификации, чтобы ваши пользователи могли отправлять запросы на поддержку.',
        'token_field' => 'Токен поддержки',
        'save_btn' => 'Сохранить настройки поддержки',
        'saved' => 'Обновлены настройки поддержки.',
        'save_error' => 'Настройки поддержки не могут быть обновлены.:error',
    ],
