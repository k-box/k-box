...
*/
	...
	'bulk' => array(
		...
		'make_public_error_title' => 'Невозможно добавить в открытую сеть K-Link',
        
        'make_public_success_text_alt' => 'Документы находятся в открытом доступе в сети K-Link',
        ...
        'make_public_inside_collection_dialog_text' => 'Вы сделаете все документы коллекции  ":item" открытыми для K-Link сети (жмите вне сообщения для отмены)',
        
        'make_public_dialog_title' => 'Сделать открытым ":item" в K-Link сети',
        'make_public_dialog_title_alt' => 'Сделать открытым в K-Link сети',
        ...
        'make_public_dialog_text' => 'Документ ":item" будет в открытом доступе в K-Link сети (жмите вне сообщения для отмены)',
        'make_public_dialog_text_count' => 'Вы сделаете :count документов открытыми в K-Link сети (жмите вне сообщения для отмены)',
	),
