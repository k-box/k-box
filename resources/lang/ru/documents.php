...
*/
    ...
    'bulk' => [
        ...
        'remove_error' => 'Невозможно удалить. Ни один документ или коллекция не были удалены. :error',
    ...
    'messages' => [
        ...
        'recent_hint_dms_manager' => 'Здесь показаны новые загрузки и изменения в доступных вам проектах.',
