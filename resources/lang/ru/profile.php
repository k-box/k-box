...
return [
    ...
    */
    ...
    'starred_count_label' => ':number документ в Избранное|:number документа в Избранное|:number документов в Избранное',
    'documents_count_label' => ':number загруженный документ |:number загруженных документа |:number загруженных документов',
    'collections_count_label' => ':number коллекция |:number коллекции |:number коллекций',
    'shared_count_label' => ':number документ с прямым доступом |:number документа с прямым доступом|:number документов с прямым доступом',
