...
return [
    ...
    */
    ...
    '503_text' => '<strong>K-Box</strong> в данный момент находится<br/><strong>на техническом обслуживании</strong><br/><small>скоро вернемся :)</small>',

    '500_title' => 'Ошибка - K-Box',
    ...
    '401_text' => 'Вы <strong>не можете</strong> просмотреть страницу<br/> так как вам не предоставили <strong>доступа</strong> к ней.',

    '403_title' => 'У вас нет полномочий для просмотра данной страницы',
    '403_text' => 'Вы <strong>не</strong> можете просмотреть данную страницу<br/>так как вам не предоставили <strong>доступа</strong> к ней.',
