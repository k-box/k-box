...
return [
    ...
    */
    ...
    'hints' => [
        ...
        'slug' => 'Короткая последовательность слов, описывающих вебсайт в его адресной строке. Данная версия URL поможет пользователям легко найти и запомнить адрес страницы. К примеру, слагом <a href="https://pasture.klink.asia/projects/pasture-network/en" target="_blank">Региональной Пастбищной Сети</a> является все, что следует за https://pasture.klink.asia/projects/.... Слаг не может начинаться со слова "создать".',
