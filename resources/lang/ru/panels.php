...
return [
    ...
    'sharing_settings_btn' => 'Настройки доступа',
    ...
    'versions' => [
        'there_is' => 'У документа есть предыдущие версии',
        'no_version' => 'Предыдущие версии документа не найдены.',
    ],

    'access' => [

        'only_you' => 'Только вы',
        'you_and_direct' => 'Вы и :num пользователь (с помощью прямой ссылки)|Вы и :num пользователя (с помощью прямой ссылки)|Вы и :num пользователей (с помощью прямой ссылки)',
