...
**3. Какой уровень дать новому пользователю?**

Выберите из:

- **гость** – может просмотривать, скачивать файлы; доступ только в раздел «Совместные»
- **партнер** –  может просматривать, изменять, скачивать, делиться файлами, создавать коллекции; доступ ко всему проекту
- **администратор проекта** – может изменять проекты, добавлять\удалять участников, создавать микро-сайт, публиковать\закрывать документы; доступ ко всему проекту

**4. Какие права обязательны?**

- для «гость» - «Просмотр документов в совместном доступе»
- для «партнер» - «Доступ к документам в разрешенных проектах», «Возможность внесения изменений в структуре доступных проектов»
- для «администратор проекта» - все выделенные

**5. Что такое микро-сайт?**

 Одна веб-страница с описанием деятельности проекта. Например, [такая](https://pasture.klink.asia/projects/pasture-network/ru).

**6. Почему микро-сайт, а не веб-сайт?**

Можно создать внутри K-Box. Не нужен отдельный хостинг. По умолчанию есть K-Link.

**7. Как создать микро-сайт проекта?**
