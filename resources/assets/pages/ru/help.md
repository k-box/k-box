...
- **Partner** –  может просматривать, изменять, скачивать, делиться файлами, создавать коллекции; доступ ко всему проекту
- **Project Manager** – может изменять проекты, добавлять\удалять участников, создавать микро-сайт, публиковать\закрывать документы; доступ ко всему проекту
