...
Нажмите на документ правой кнопкой мыши, и выберите опцию «Изменить». На открывшейся странице, в левой нижней части, выберите нужный язык, и нажмите «Сохранить». ![](https://k-box.oneofftech.xyz/klink/a5ccd20581/download) 
...
**1. Как мне создать свои персональные коллекции? (picture)**
