 ...
 * Modified by Alessio Vertemati
 */

context = (function () {

	var createCallback = function(func) {
	    return function(event) { func.call(currentContextSelector, event, currentContextSelector) };
	}
	...
	function addContext(selector, _trigger, data) {
		...
		$(selector).on('contextmenu', _trigger, function (e) {
			e.preventDefault();
			e.stopPropagation();

            currentContextSelector = $(this);

            console.warn('Context menu called', currentContextSelector, e, this);
