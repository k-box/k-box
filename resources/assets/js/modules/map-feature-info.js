define("modules/map-feature-info", ["jquery", "language"],
    function ($, Lang) {
        ...
        var internal = {
            ...
            renderFeatureDetails: function(feature){
                if(feature.properties.GRAY_INDEX){
                    return '<div class="map__feature"><span class="map__feature-label">'+Lang.trans('preview.map.value_label')+'</span> <strong>' + feature.properties.GRAY_INDEX + '</strong></div>';
                }
