...
<div {{ $attributes->merge(['class' => 'flex justify-between items-center']) }} 
    ...
    @can('create', \KBox\Publication::class)
        ...
        <div class="flex flex-no-wrap form-input p-1">
            ...
            <button type="submit" class="c-switch__button" @click="publish"  :class="{'c-switch__button--selected': published}" title="{{ trans('networks.publish_to_short') }}">
