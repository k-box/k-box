...
<div class=" mb-4">
    <label for="copyright_usage" class="font-bold">{{trans('documents.edit.license')}}</label>
...
<div class=" mb-4">
    <label for="copyright_owner_name" class="font-bold">{{trans('documents.edit.copyright_owner')}}</label>
    ...
    @endif
    <input type="text" name="copyright_owner_name" id="copyright_owner_name" value="{{old('copyright_owner_name', isset($owner) ? $owner->get('name') : '')}}" class="form-input mt-1 mb-2 block w-2/3" @if(!$document->isMine() || !$can_edit_document) disabled @endif> 
    ...
    @endif
    <input type="text" name="copyright_owner_email" id="copyright_owner_email" value="{{old('copyright_owner_email', isset($owner) ? $owner->get('email') : '')}}" class="form-input mt-1 mb-2 block w-2/3" @if(!$document->isMine() || !$can_edit_document) disabled @endif> 
    ...
    @if( $errors->has('copyright_owner_website') )
        ...
        @endif
        <input type="text" name="copyright_owner_website" id="copyright_owner_website" placeholder="https://" value="{{old('copyright_owner_website', isset($owner) ? $owner->get('website') : '')}}" class="form-input mt-1 mb-2 block w-2/3" @if(!$document->isMine() || !$can_edit_document) disabled @endif> 
    ...
    @endif
        <input type="text" name="copyright_owner_address" id="copyright_owner_address" value="{{old('copyright_owner_address', isset($owner) ? $owner->get('address') : '')}}" class="form-input mt-1 mb-2 block w-2/3" @if(!$document->isMine() || !$can_edit_document) disabled @endif> 
