...
@elseif (class_basename(get_class($item)) === 'DocumentDescriptor')
	...
	@component('components.list-item', 
		[
			...
			'shared_on' => isset($share_created_at_timestamp) ? $share_created_at_timestamp->render(true) : false,
			'shared_on_diff' => isset($share_created_at) ? $share_created_at->render() : false,
