        ...
        <form  method="post" class="c-form" action="{{route('administration.identity.store')}}">
            ...
            <div class="c-section">
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="text" required name="name" value="{{old('name', isset($contacts['name']) && !is_null($contacts['name']) ? $contacts['name'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="email" required name="email" value="{{old('email', isset($contacts['email']) && !is_null($contacts['email']) ? $contacts['email'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input" type="text" name="phone" value="{{old('phone', isset($contacts['phone']) && !is_null($contacts['phone']) ? $contacts['phone'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="text" name="website"  placeholder="http://" value="{{old('website', isset($contacts['website']) && !is_null($contacts['website']) ? $contacts['website'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="text" name="image" placeholder="http://" value="{{old('image', isset($contacts['image']) && !is_null($contacts['image']) ? $contacts['image'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="text" name="address_street" value="{{old('address_street', isset($contacts['address_street']) && !is_null($contacts['address_street']) ? $contacts['address_street'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input c-form__input--larger" type="text" name="address_locality" value="{{old('address_locality', isset($contacts['address_locality']) && !is_null($contacts['address_locality']) ? $contacts['address_locality'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input" type="text" name="address_country" value="{{old('address_country', isset($contacts['address_country']) && !is_null($contacts['address_country']) ? $contacts['address_country'] : '')}}" />
                </div>
                ...
                <div class="c-form__field">
                    ...
                    @endif
                    <input class="c-form__input" type="text" name="address_zip" value="{{old('address_zip', isset($contacts['address_zip']) && !is_null($contacts['address_zip']) ? $contacts['address_zip'] : '')}}" />
                </div>
