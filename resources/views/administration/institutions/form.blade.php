    ...
    <div class=" mb-4">
        ...
        @else
            ...
            <input class="form-input block" type="text" required name="klink_id" value="{{old('klink_id', isset($institution) ? $institution->klink_id : '')}}" />
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block w-2/3" type="text" required name="name" value="{{old('name', isset($institution) ? $institution->name : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="email" required name="email" value="{{old('email', isset($institution) ? $institution->email : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" required name="phone" value="{{old('phone', isset($institution) ? $institution->phone : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" required name="url"  placeholder="http://" value="{{old('url', isset($institution) ? $institution->url : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" required name="thumbnail_uri" placeholder="http://" value="{{old('thumbnail_uri', isset($institution) ? $institution->thumbnail_uri : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" name="address_street" value="{{old('address_street', isset($institution) ? $institution->address_street : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" name="address_locality" value="{{old('address_locality', isset($institution) ? $institution->address_locality : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" name="address_country" value="{{old('address_country', isset($institution) ? $institution->address_country : '')}}" />
    </div>
    ...
    <div  class=" mb-4">
        ...
        @endif
        <input class="form-input block" type="text" name="address_zip" value="{{old('address_zip', isset($institution) ? $institution->address_zip : '')}}" />
    </div>
