...
@section('form')
	...
	<form method="post" class="c-form c-form--space" action="{{ route('password.update') }}">
		...
		<div class=" mb-4 mb-4">
			...
			@endif
			<input type="email" class="form-input block w-2/3" required id="email" name="email" value="{{old('email')}}" />
		</div>
		...
		<div class=" mb-4 mb-4">
			...
			@endif
			<input type="password" class="form-input block w-2/3" name="password" />
		</div>
		...
		<div class=" mb-4 mb-4">
			...
			@endif
			<input type="password" class="form-input block w-2/3" name="password_confirmation" />
		</div>
