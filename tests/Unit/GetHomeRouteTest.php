...
class GetHomeRouteTest extends TestCase
{
    ...
    public function expected_route_for_capabilities()
    {
        return [
            ...
            [Capability::$PROJECT_MANAGER_NO_CLEAN_TRASH, 'documents.index'],
    ...
    public function expected_route_for_capabilities_based_on_flags()
    {
        return [
            ...
            [Capability::$PROJECT_MANAGER_NO_CLEAN_TRASH, Flags::HOME_ROUTE_PROJECTS, 'documents.projects.index'],
            ...
            [Capability::$PROJECT_MANAGER_NO_CLEAN_TRASH, Flags::HOME_ROUTE_RECENT, 'documents.recent'],
