...
class UserImportCommandTest extends TestCase
{
    ...
    public function testDmsUserImportCommandWithValidFileAndFiveColumns()
    {
        ...
        $this->assertMatchesRegularExpression('/([\|\s]*)user-6([\s\w\S\W.]*)5    | The selected role is invalid. - The selected manage projects is invalid. - The selected add to projects is invalid\./', $res);
        
        // user7 -> add_to_project error
        $this->assertMatchesRegularExpression('/([\|\s]*)user-7([\s\w\S\W.]*)6    \| The selected add to projects is invalid\./', $res);
    }
