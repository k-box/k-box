...
class DmsUpdateCommandTest extends TestCase
{
    ...
    public function test_that_user_uuids_are_generated()
    {
        ...
        $users = factory(User::class, 10)->create(['uuid' => "00000000-0000-0000-0000-000000000000"]);
        $v3_users = factory(User::class)->create(['uuid' => "39613931-3436-3066-2d31-3533322d3466"]);
        $null_users = tap(factory(User::class)->create(), function ($u) {
