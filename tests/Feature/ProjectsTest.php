...
class ProjectsTest extends TestCase
{
    ...
    public function routes_and_capabilities_provider()
    {
        return [
            ...
            [ Capability::$DMS_MASTER, 'projects.index', 403 ],
            [ Capability::$DMS_MASTER, 'projects.show', 403 ],
            [ Capability::$DMS_MASTER, 'projects.create', 403 ],
            [ Capability::$DMS_MASTER, 'projects.edit', 403 ],
