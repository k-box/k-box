...
class FileContentExtractor {
	...
	public function extract($mimeType, $filePath, $default = null){
		...
		// dd(compact('mimeType', 'extension', 'filePath'));
		...
		if(method_exists($this, $extension)){
			...
			try{
				...
				\Log::error('Error extracting text from file', array('context' => 'FileContentExtractor', 'param' => compact('mimeType', 'extension', 'filePath'), 'exception' => $ex));
