...
<!--<p>
    <label>{{trans('microsites.labels.page_title')}}</label>
    <span class="description">{{ trans('microsites.hints.page_title') }}</span>
</p>

<p>
    <label>{{trans('microsites.labels.page_slug')}}</label>
    <span class="description">{{ trans('microsites.hints.page_slug') }}</span>
</p>-->
...
<p>
    ...
    <textarea class="u-full-width content-textarea" type="text" name="content[en][content]" required >{{ old('content.en.content', isset($en_entity) ? $en_entity->content : '') }}</textarea>
...
<p>
    ...
    <textarea class="u-full-width content-textarea" type="text" name="content[ru][content]" required >{{ old('content.ru.content', isset($ru_entity) ? $ru_entity->content : '') }}</textarea>
