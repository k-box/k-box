...
<div class=" mb-4">
    ...
    <textarea class="form-input form-input--full-width content-textarea" type="text" name="content[en][content]" required >{{ old('content.en.content', isset($en_entity) ? $en_entity->content : '') }}</textarea>
...
<div class=" mb-4">
    ...
    <textarea class="form-input form-input--full-width content-textarea" type="text" name="content[ru][content]" required >{{ old('content.ru.content', isset($ru_entity) ? $ru_entity->content : '') }}</textarea>
